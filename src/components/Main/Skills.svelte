		...
		<div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
			<dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-gray-900 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
				...
				<div class="relative pl-9">
					...
					<dd class="inline">Administration de réseaux locaux, configuration de routeurs et sécurité réseau.</dd>
				</div>
				...
				{#if voirPlus}
					...
					<div class="relative pl-9">
						<dt class="inline font-semibold text-gray-900">
							...
							Java (débutant)						</dt>
						<dd class="inline">Notions en Java pour le développement d'applications.</dd>
					</div>
				{/if}
			</dl>
			<button
