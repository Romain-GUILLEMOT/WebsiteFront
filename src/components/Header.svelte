...
<header class="absolute inset-x-0 top-0 z-20">
	<nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
		...
		<div class="hidden lg:flex lg:gap-x-12">
			...
			<a href="/alternance" class="text-sm font-semibold leading-6 {($page.url.pathname.startsWith('/alternance')) ? 'text-blue-500' : 'text-red-500'}">Alternance / CV</a>
			...
			<div class="mt-6 flow-root">
				<div class="-my-6 divide-y divide-gray-500/10">
					<div class="space-y-2 py-6">
						...
						<a href="/alternance" on:click={editDialog} class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 {($page.url.pathname.startsWith('/alternance')) ? 'text-blue-500' : 'text-red-500'} hover:bg-gray-50">Alternance / CV</a>
